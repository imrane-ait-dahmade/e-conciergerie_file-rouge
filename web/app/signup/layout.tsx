// Même en-tête que la home pour /signup (hors préfixe /fr).
// Fond dégradé + halos animés sur la zone auth uniquement.
...
export default async function SignupRouteLayout({
  children,
}: {
