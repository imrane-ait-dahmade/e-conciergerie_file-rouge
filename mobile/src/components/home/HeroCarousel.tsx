...
const styles = StyleSheet.create({
  ...
  overlayVignette: {
    ...StyleSheet.absoluteFillObject,
    backgroundColor: Colors.overlayBlackSoft,
  },
  overlayBottom: {
    position: 'absolute',
    left: 0,
  ...
  badge: {
    ...
    backgroundColor: Colors.overlayWhiteSubtle,
    borderWidth: 1,
    borderColor: Colors.overlayWhiteBorder,
  },
  badgeText: {
    fontSize: FontSize.xs,
    fontWeight: '600',
    color: Colors.textBadgeOnImage,
    letterSpacing: 0.8,
  ...
  location: {
    ...
    textShadowColor: Colors.textShadowDim,
    textShadowOffset: { width: 0, height: 1 },
    textShadowRadius: 6,
  },
  ctaPill: {
    ...
    borderRadius: 999,
    borderWidth: 1,
    borderColor: Colors.ctaPillBorder,
    ...Platform.select({
      ios: {
        shadowColor: Colors.shadow,
  ...
  dotsTrack: {
    ...
    borderRadius: 100,
    backgroundColor: Colors.dotsTrackBg,
  },
  dot: {
    width: 6,
    height: 6,
